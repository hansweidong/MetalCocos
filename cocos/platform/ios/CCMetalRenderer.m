...
//cocosの設計的には、CCEAGLViewがEAGLRendererを持つので、それに対応してMetalViewがMetalRendererを
//持つようにしようと思ったが、MetalRendererがやることをCCRenderer自体がカバーできれば不要な気もする。
#if 0
...
@implementation CCMetalRenderer
{
